    ...
    return (
        <React.Fragment>
            ...
            <div id="ProductDetail">
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-lg-6 d-none d-lg-block">
                            <img id="productDetail-main-image" src={product.media?.photos?.[0]?
             `${contentURL}/${product.media.photos[0]}` : ""} alt="Front Product Image"/>
                        </div>
                            ...
                            <div id="productDetail-productDescription-container">
                                ...
                                <p>
                                    <span className="productDetail-productTag">
                                        <FormattedMessage id="Type"/></span> - {product.productType? <FormattedMessage id={product.productType}/> : ""}<br/>
                                    <span className="productDetail-productTag">
                                        <FormattedMessage id="Labour"/> </span> - {product.productLabour? <FormattedMessage id={product.productLabour}/>: ""}<br/>
                                    <span className="productDetail-productTag">
             ...
             `${contentURL}/${product.media.photos[0]}` : ""} alt="Foto Producto"/>
                        </div>
                        <div className="col-12 col-lg-4">
                            <img src={product.media?.photos?.[1]?
             `${contentURL}/${product.media.photos[1]}` : ""} alt="Foto Producto"/>
                        </div>
                        <div className=" col-12 col-lg-4">
                            <img src={product.media?.photos?.[2]?
             `${contentURL}/${product.media.photos[2]}` : ""} alt="Foto Producto"/>
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-7 col-lg-4">
                            <img id="productDetail-map" src={department.mapColorRegion ? `https://s3.amazonaws.com/${process.env.REACT_APP_BUCKET_ID}/frontend/departments/${department.mapColorRegion}` : ""} alt="Mapa Colombia"/>
                        </div>
             ...
             artisan.shortDescriptionES}
                            ...
                            <div className='row' id="productDetail-artisans-images-row">
                                <div className='col-12 col-lg-6'>
                                    <img src={artisan.media? `${contentURL}/${artisan.media?.technique[1]}` : ""} alt="Artisans photo 1"/>
                                </div>
                                <div className='col-12 col-lg-6'>
                                    <img src={artisan.media? `${contentURL}/${artisan.media?.technique[2]}`: ""} alt="Artisans photo
             2"/>
                                </div>
                            </div>
                        </div>
