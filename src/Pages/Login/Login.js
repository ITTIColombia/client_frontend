                    ...
                    <div className="col-6 login-form">
                        ...
                        <form className="login-normal-text ">
                            <div className="form-group login-form-section">
                                ...
                                <input name="email" type="email" className="form-control login-input" id="email" value={form.email} onChange={handleChange}/>
                            </div>
                            <div className="form-group login-form-section">
                                <label htmlFor="password">Password</label>
                                <input name="password" type="password" className="form-control login-input" id="password" aria-describedby="passwordHelp" value={form.password} onChange={handleChange}/>
